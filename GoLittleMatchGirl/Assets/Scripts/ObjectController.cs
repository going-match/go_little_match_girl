...
public class ObjectController : MonoBehaviour
{
    ...
    private float[,] stoveSpawnPercentage = { { 0.4f, 0.5f }, { 0.6f, 0.7f }, { 0.8f, 0.9f } };
    private bool[] isPotionSpawned;     // 3개의 생성구간에서 생성되었는지 여부
    ...
    private void Awake()
    {
        ...
        isPotionSpawned = new bool[potionSpawnPercentage.Length];
        isStoveSpawned = new bool[stoveSpawnPercentage.Length];
        ...
        if (GameManager.Instance.IsPlaying())
        {
            ...
            for (int i=0; i<potion.Length; i++)
            {
                ...
                if (potion[i].activeSelf)
                {
                    ...
                    potionPos.x -= (Time.deltaTime * speed * 50f);
            ...
            for (int i=0; i<stove.Length; i++)
            {
                ...
                if (stove[i].activeSelf)
                {
                    ...
                    stovePos.x -= (Time.deltaTime * speed * 50f);
