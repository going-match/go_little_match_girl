...
public class ObjectSpawner : MonoBehaviour
{
    ...
    //창문 처음 시작 위치
    Vector3 windowStartPosition = new Vector3(-10, -4, 0);

    //타일 prefab
    [SerializeField]
    private GameObject TilePrefab;
    //타일 처음 시작 위치
    Vector3 tileStartPosition = new Vector3(-10, -5, 0);
    ...
    void Update()
    {
        ...
        //기본 건물 블록의 세로와 가로 길이
        Vector3 verticalGap = new Vector3(0, 2, 0);
        Vector3 horizontalGap = new Vector3(3, 0, 0);
        ...
        for(int i = 0; i < blockNum-1; i++){
          ...
          //건물 블록 생성
          GameObject buildingBlock = Instantiate(prefabArray[prefabArrayidx], buildingStartPosition, rotation);
          //건물 이동 벡터
          ...
          while(true){
            ...
            //창문 랜덤 결정
            int prefabWindowArrayidx = Random.Range(0,4);
            ...
            //두 번째 창문 위치 지정
            windowBuildingPosition = windowBuildingPosition + new Vector3(1f, 0, 0);
            windowNum++;
          }

          //창문 생성 후 다음 위치 이동.
          windowBuildingPosition = windowBuildingPosition + verticalGap + new Vector3(-2f, 0, 0);


          }

        //마지막 지붕
        GameObject lastBuildingBlock = Instantiate(prefabArray[3], buildingStartPosition, rotation);
        ...
        //타일의 랜덤 사이즈
        int tileScale = Random.RandomRange(6, 8);
        Debug.Log("타일사이즈: " + tileScale);
        //타일 생성
        GameObject tileBlock = Instantiate(TilePrefab, tileStartPosition, rotation);
        //타일 가로 길이
        tileBlock.transform.localScale = new Vector3(tileScale, 0.2f, 0);
        //타일 y축 높이
        int tileHeight = Random.RandomRange(0, 5);
